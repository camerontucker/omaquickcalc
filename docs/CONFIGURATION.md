...
to `~/.config/omaquickcalc/config.json`. Edit the JSON file and reopen the
palette to apply a change.
...
| `backgroundOpacity` | `0`–`1` | Floating card opacity; text, results, borders, and the scrim remain separate. |
